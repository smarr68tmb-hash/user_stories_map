...
- ✅ **📊 Анализ схожести** — TF-IDF поиск дубликатов и похожих историй (NEW!)
- ✅ **✅ Валидация карты** — проверка структуры и качества требований (NEW!)
...
### 📊 Анализ схожести и валидация (NEW!)
