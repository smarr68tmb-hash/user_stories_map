...
- ✅ Визуальное представление интерфейса, которое можно "увидеть"
...
КРИТИЧЕСКИ ВАЖНО: 
Ты ДОЛЖЕН создать ВИЗУАЛЬНЫЙ ASCII wireframe - это схема интерфейса, которую можно УВИДЕТЬ глазами.
...
- Структуру интерфейса (header, sidebar, main area) с box-drawing символами
...
ПОМНИ: wireframe - это ВИЗУАЛЬНАЯ схема, а не JSON описание!
"""
